			...
			<div class="top-menu pull-left">
				<ul class="nav navbar-nav">
					...
					<li  class="dropdown dropdown-extended ">
					   <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
							<i class="fa fa-question" aria-hidden="true" data-type="lock-icon"><strong style="font-size:5px"></strong></i>
						</a>
					   <ul  class="dropdown-menu">
					    <li class="external">
								<a href="javascript:;" ><span>技术支持 <i class="fa fa-qq"></i>:775977777</span></a>
								<a href="javascript:;"><span>售前客服 <i class="fa fa-qq"></i>:3381601575</span></a>
							</li>
					  </ul>
					</li>
				</ul>
