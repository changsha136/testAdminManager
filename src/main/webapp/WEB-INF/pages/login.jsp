	...
	<form class="login-form" id="loginForm" action="javascript:;">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" autofocus/>
			</div>
		</div>
		<div class="form-group">
...
<canvas id="background-canvas" background="color:red!important"></canvas>
