...
//		criterions.add(Restrictions.eq("upid", Global.USER_TOP_ID));// 上级是总账     modify by Andy
		criterions.add(Restrictions.in("code", new Integer[]{1998,2000}));
...
//		criterions.add(Restrictions.not(Restrictions.eq("upid", 0)));
		criterions.add(Restrictions.eq("code", 1996));
		criterions.add(Restrictions.not(Restrictions.in("AStatus", Arrays.asList(-2, -3))));// 非永久冻结及禁用状态
